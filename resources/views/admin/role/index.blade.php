			  		...
			  		<div class="card">
			  			<div class="card-header">
			  				...
			  				<div class="d-flex justify-content-between align-items-center">
				  				...
				  				<div>
				  					<a href="{{ route('admin.role.create') }}" class="btn btn-outline-primary">Add New</a>
				  				</div>
			  				</div>
			  			</div>
			  			<div class="card-body">
			  				<table id="roles-table" class="table table-bordered table-hover roles-table">
			  					<thead>
			  						<tr>
			  							<th>#</th>
			  							<th>Name</th>
...
@section('footer-script')
	<script type="text/javascript">
		const ROLE_URL = '{{ route('admin.role.index') }}';
	</script>
